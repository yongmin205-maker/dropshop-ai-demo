...
- [ ] Run `phase25v_backfill_review_and_fix.md` against backfill.ts (3 sub-agents + lead pass)
- [ ] Apply blocker/should-fix findings, push to branch `phase/25v-backfill-review-fix`
- [ ] Read `docs/mainstreet-ai/reviews/phase25v_backfill_review.md`, decide ship/hold
